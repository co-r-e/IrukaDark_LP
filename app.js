...
const translations = {
  en: {
    ...
    'hero.title': '<span class="grad-white">A full-screen AI assistant</span> for mastering multiple tools and accelerating your work',
  ...
  ja: {
    ...
    'hero.title': '複数のデジタルツールを使いこなし、作業速度を上げたい人のための<span class="grad-white">全画面AIアシスタント</span>',
