...
const translations = {
  en: {
    ...
    'chat.atcommand.title': '@ Commands',
    'chat.atcommand.subtitle': 'Type @ followed by a command name and your prompt to generate content directly in chat.',
    'chat.slash.title': 'Slash Commands',
    'chat.slash.subtitle': 'Type / in the chat to open the command palette. Commands operate on your current conversation.',
  ...
  ja: {
    ...
    'chat.atcommand.title': '@コマンド',
    'chat.atcommand.subtitle': '@に続けてコマンド名とプロンプトを入力すると、チャット内で直接コンテンツを生成できます。',
    'chat.slash.title': 'スラッシュコマンド',
    'chat.slash.subtitle': 'チャット欄で / を入力するとコマンドパレットが開きます。現在の会話に対して各コマンドが動作します。',
    'atcommand.image.title': '@image',
