...
const translations = {
  en: {
    ...
    'hero.title': 'Accelerate your information understanding, <span class="grad-white">your full-screen AI assistant</span>',
  ...
  ja: {
    ...
    'hero.title': '情報理解を高速にする<br><span class="grad-white">全画面AIアシスタント</span>',
