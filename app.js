...
const translations = {
  en: {
    ...
    'features.instant.description': 'No need to type prompts like "please explain this." Just hit the shortcut on whatever catches your attention on screen. It explains instantly, right there, without leaving your current view.',
  ...
  ja: {
    ...
    'features.instant.description': 'わざわざ「この意味を教えてください」なんてプロンプトを入力する必要はありません。画面上の気になるものにショートカットを押すだけ。同じ画面のまま、その場で瞬時に解説してくれます。',
...
(function osAwareDownloadButtons() {
  ...
  onDOMReady(updateDownloadButtonsForOS);
})();
