...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Instant explanations, terminal, and clipboard tools, all in one. A compact AI utility summoned by a single shortcut, packed with powerful features to accelerate your workflow.',
    ...
    'howto.group.text': 'Text Explanation',
    'howto.group.url': 'URL Explanation',
    'howto.group.translate': 'Translate & Rephrase',
    ...
    'howto2.commands.video.description': 'Type <code>@video</code> followed by a space and your prompt in the chat to generate videos. Use <code>/video</code> to configure video size, duration, quality, and the number of videos to generate.',
    'cta.title': 'Download',
  ...
  ja: {
    ...
    'hero.subtitle': '画面の「瞬間解説」も、ターミナルも、クリップボード拡張もこれひとつ。ショートカット一発で現れる小さなAIに、デスクワークを加速させる強力な機能を凝縮したオールインワン・ユーティリティ。',
    'hero.cta': '<svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" style="margin-right: 3px; vertical-align: middle;"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>Mac用ダウンロード',
    ...
    'howto.group.text': 'テキスト解説',
    'howto.group.url': 'URL解説',
    'howto.group.translate': '翻訳・言い換え',
    ...
    'howto2.commands.video.title': '/video',
    'howto2.commands.video.description': 'チャット欄に <code>@video</code> と打って半角スペースを入れてからプロンプトを入力すると動画を生成できます。<code>/video</code> では生成する動画のサイズ、時間、品質、本数を設定できます。',
    'cta.title': 'ダウンロード',
